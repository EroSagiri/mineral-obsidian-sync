...
const TYPES: SyncOperation["type"][] = ["upload", "download", "delete-local", "delete-remote", "prune-baseline", "resolve-keep-local", "resolve-keep-remote", "resolve-merged", "resolve-accept-remote-delete", "resolve-accept-local-delete", "conflict", "noop"];
const LABELS: Record<SyncOperation["type"], string> = { upload: "Upload", download: "Download", "delete-local": "Move Local To Trash", "delete-remote": "Logical Delete Remote", "prune-baseline": "Forget Stale Baseline", "resolve-keep-local": "Resolve: Keep Local", "resolve-keep-remote": "Resolve: Keep Remote", "resolve-merged": "Resolve: Merged", "resolve-accept-remote-delete": "Resolve: Accept Remote Delete", "resolve-accept-local-delete": "Resolve: Accept Local Delete", conflict: "Conflict", noop: "Unchanged" };
